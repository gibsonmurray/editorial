  ...
  return (
    <div className="toolbar">
      <div className="tb-group">
        <ToolbarButton icon={<Undo2 size={18} />} label="Undo" kbd={`${cmd}Z`} onClick={onUndo} disabled={!canUndo} />
        <ToolbarButton icon={<Redo2 size={18} />} label="Redo" kbd={`${cmd}${shift}Z`} onClick={onRedo} disabled={!canRedo} />
      </div>
      <div className="tb-group">
        <ToolbarButton icon={<FileCheck size={18} />} label="Accept" kbd={`${cmd}K`} className="accept" onClick={onAcceptFocused} disabled={!hasFocused} />
        <ToolbarButton icon={<CheckSquare size={18} />} label="Accept All" kbd={`${cmd}${shift}K`} className="accept-all" onClick={onAcceptAll} disabled={!pendingCount} badge={pendingCount} />
        <ToolbarButton icon={<FileX size={18} />} label="Reject" kbd={`${cmd}L`} className="reject" onClick={onRejectFocused} disabled={!hasFocused} />
        <ToolbarButton icon={<XSquare size={18} />} label="Reject All" kbd={`${cmd}${shift}L`} className="reject-all" onClick={onRejectAll} disabled={!pendingCount} />
      </div>
      <div className="tb-group">
