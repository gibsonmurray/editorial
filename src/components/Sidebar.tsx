    ...
    return (
        <aside className="sidebar">
            ...
            <div className="sidebar-mode-tabs">
                ...
                <button
                    type="button"
                    className={mode === "marks" ? "active" : ""}
                    onClick={() => onModeChange("marks")}
                >
                    Editor's Marks
                </button>
            </div>
                ...
                <div className="sidebar-scroll">
                    <div className="section">
                        ...
                        {!hasKey && (
                            ...
                            >
                                ※ Open Settings to add your API key. Keys live
            ...
            <div className="statbar">
                <div className="stat">
                    <span className="num">{stats.words}</span>
                    <span className="lbl">words</span>
                </div>
                <div className="sep" />
                <div className="stat">
                    <span className="num">{stats.chars}</span>
